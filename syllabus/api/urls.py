...
from .views import SyllabusLevelListAPIView, SyllabusAllListAPIView, UserSyllabusUserViewSet, \
    SyllabusLevelCourseAPIView, UserSyllabusAPIView, AdminUserSyllabusAPIView
...
urlpatterns = [
    ...
    path('admin/user/<int:user>/level/<int:level>/course/<int:course>/', AdminUserSyllabusAPIView.as_view())
]

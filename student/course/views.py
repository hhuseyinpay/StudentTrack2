...
from student.course.models import CourseGroups, Course
from .serializers import CourseGroupModelSerializer, CourseGroupListSerializer, CourseModelSerializer

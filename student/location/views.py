...
from student.account.serializers import UserModelSerializerV2
from student.location.models import ClassRoom, Area, Region
from .permissions import CanEditClassroom, CanEditArea
from .serializers import (ClassRoomListSerializer, AreaListSerializer,
...
class AdminClassroomViewSet(viewsets.ModelViewSet):
    ...
    def teachers(self, request, pk=None):
        ...
        body = UserModelSerializerV2(teachers, many=True).data
...
class AdminAreaViewset(viewsets.ModelViewSet):
    ...
    def executives(self, request, pk=None):
        ...
        body = UserModelSerializerV2(executives, many=True).data
        return Response(data=body, status=status.HTTP_200_OK)
